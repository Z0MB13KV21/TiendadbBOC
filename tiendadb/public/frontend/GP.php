...
<body>
    ...
    <label for="RA" style="display:none;"><?php echo htmlspecialchars($role); ?></label>
                ...
                <div class="modal-body">
                    <form id="productForm">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Agrege una Descripción del Producto" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="price">Precio:</label>
                            <input type="number" step="0.01" class="form-control" id="price" name="price" placeholder="Ingrese el Valor del Producto" required>
                        </div>
                        <div class="form-group">
                            <label for="stock">Stock:</label>
                            <input type="number" class="form-control" id="stock" name="stock"  placeholder="Ingrese la Cantidad"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="enlace" name="enlace"  placeholder="Ingrese el Enlace del Producto"required>
                        </div>
                        <div class="form-group">
