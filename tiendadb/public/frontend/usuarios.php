...
@media (prefers-color-scheme: dark) {
    ...
    .container, .row, .col-md-3, .col-md-9, .form-group, .btn, .nav-link, .tab-content, .tab-pane, h1, h3, label, p, td, th {
    color: #ffffff !important;
}
#userRole, #userStatus, #editUserRole, #editUserStatus{color:#121212 !important}
    .error-container h1 {
    ...
    .btn-custom, .btn-primary {
        background-color: #69ff5c !important;
        color: #121212 !important;
    }
        .btn-danger,.btn-secondary{
        background-color: #ff2f34  !important;
        color: #ffffff !important;
    }
...
@media (prefers-color-scheme: light) {
    ...
    .nav-link.active{background-color: #404040 !important;
    color:#ffffff !important;}
    .error-container h1 {
        color: #ff0722 !important;
    }
    ...
    .btn-custom,  .btn-secondary, .btn-primary{
        background-color: #404040 !important;
        color: #ffffff !important;
    }
    .btn-danger{
